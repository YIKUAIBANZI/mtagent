...
```json
{
  "city": "string，必填，中国城市/地区名，按用户原文提取。已内置 POI 库：深圳/上海/西安/北京/南昌；其他城市（哈尔滨/成都/杭州/武汉/广州/重庆/天津/苏州/南京/沈阳/长春/青岛/大连/厦门/福州/济南/合肥/郑州/长沙/昆明/贵阳/海口/三亚/兰州/银川/西宁/乌鲁木齐/拉萨/呼和浩特/太原/石家庄/南宁等）走高德实时搜索路径同样支持。只要用户提到中国某城市/地区就直接填，不要返 null。",
