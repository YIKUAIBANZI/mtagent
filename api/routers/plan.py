"""POST /api/plan/stream — SSE main flow endpoint (生成行程)."""
...
from agents.transits import compute_day_transits
...
from api.routers._shared import cookie_key as _cookie_key, merge_extra as _merge_extra
from api.services.instant import stream_instant_variants
...
async def plan_stream(
    ...
    async def event_stream() -> AsyncIterator[str]:
        ...
        try:
            ...
            prefetch_task = asyncio.create_task(prefetch_amap_pois(ctx.intent, []))
        ...
        if _is_instant(ctx.intent):
            async for ev in stream_instant_variants(
                ctx,
            ...
            try:
                ...
                for fut in asyncio.as_completed(tasks):
                    ...
                    try:
                        ...
                        _, segs = await compute_day_transits(day_plan, intent, amap)
                        yield format_event(
